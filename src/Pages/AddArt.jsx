        ...
        <div className="max-w-lg mx-auto py-8 px-4 bg-white">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                    ...
                    <input type="text" name="subcategory_Name" className="w-full border bg-white border-gray-300 rounded px-3 py-2"  required />
                </div>
                <div>
                ...
                <div className="md:flex md:justify-between">
                    <div className="md:w-1/2">
                        ...
                        <input type="text" name="customization" className="w-full border bg-white border-gray-300 rounded px-3 py-2" required  />
                    </div>
                    <div className="md:w-1/2 md:ml-2">
                ...
                <div>
                    ...
                    <input type="text" name="stockStatus" className="w-full border bg-white border-gray-300 rounded px-3 py-2" required  />
                </div>
