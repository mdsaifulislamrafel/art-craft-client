            ...
            <div className="container px-6 py-4 mx-auto">
                <div className="lg:flex lg:items-center lg:justify-between">
                    <div className="flex items-center justify-between">
                        <img className='w-16 h-16 mr-1 md:mr-5 rounded-full ' src="https://images.pexels.com/photos/12984939/pexels-photo-12984939.jpeg?auto=compress&cs=tinysrgb&w=600" alt="" />
                    ...
                    <div className={`${isOpen ? 'block' : 'hidden'} lg:flex md:gap-5 lg:items-center lg:mx-8`}>
                        ...
                        <div className="flex items-center mt-4 lg:mt-0">
                            <div className="flex gap-2 items-center">
                                ...
                                <button className='btn btn-success text-white btn-sm'>Log Out</button>
                            </div>
