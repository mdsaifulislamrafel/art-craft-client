        ...
        <section className=" bg-white text-gray-600 body-font overflow-hidden">
            ...
            <div className="container px-5 py-24 mx-auto">
                <div className="lg:w-4/5 mx-auto flex flex-wrap">
                    <div data-aos="zoom-out-right" data-aos-duration="1000" className="lg:w-1/2 w-full lg:pr-10 lg:py-6 mb-6 lg:mb-0">
                    ...
                    <img data-aos="zoom-out-left" data-aos-duration="1000" alt="ecommerce" className="lg:w-1/2 w-full lg:h-[550px] h-64 object-cover object-center rounded" src={image} />
                </div>
            </div>
        </section>
    );
