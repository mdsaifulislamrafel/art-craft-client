...
const Category = ({ category }) => {
    const { _id, image, item, subcategory, price, stockStatus } = category;
    return (
        <div data-aos="fade-up" data-aos-duration="1000" className="mx-auto w-full space-y-6 rounded-xl bg-white px-4 pb-8 pt-4 font-sans shadow-lg">
